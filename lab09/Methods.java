...
public class Methods {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Do you want to make a new sentence? If yes, enter 1. ");
        int answer = 1; // initialize variable

        if (myScanner.hasNextInt() == 1) { // determine if the input is an integer
            System.out.println("The " + adjective() + " " + subject() + " " + verb() + " the " + object() + ".");
            Scanner myScanner = new Scanner(System.in); // creates a place for the user to add input
            System.out.print("Do you want to make a new sentence? If yes, enter 1. ");
        }
